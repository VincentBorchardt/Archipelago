...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "Priesthood": ItemClassification.useful,
    "Bronze Working": ItemClassification.progression,
    "Polytheism": ItemClassification.useful,
    "Monotheism": ItemClassification.useful,
    "Meditation": ItemClassification.useful,
    "Monarchy": ItemClassification.progression,
    "Alphabet": ItemClassification.useful, # Change if spying becomes useful
    ...
    "Literature": ItemClassification.useful,
    "Aesthetics": ItemClassification.useful,
    "Banking": ItemClassification.useful,
    ...
    "Philosophy": ItemClassification.useful,
    "Optics": ItemClassification.progression,
    "Theology": ItemClassification.useful,
    "Paper": ItemClassification.useful,
    "Music": ItemClassification.progression,
    "Divine Right": ItemClassification.useful,
    "Economics": ItemClassification.useful,
    "Constitution": ItemClassification.useful,
    "Astronomy": ItemClassification.progression,
    "Democracy": ItemClassification.useful,
    "Education": ItemClassification.progression,
    "Chemistry": ItemClassification.useful,
    "Corporation": ItemClassification.useful,
    "Replaceable Parts": ItemClassification.useful,
    "Gunpowder": ItemClassification.progression,
    "Rifling": ItemClassification.progression,
    "Printing Press": ItemClassification.useful,
    "Nationalism": ItemClassification.useful,
    "Military Science": ItemClassification.useful,
    "Military Tradition": ItemClassification.progression,
    "Liberalism": ItemClassification.useful,
    "Railroad": ItemClassification.progression,
    "Electricity": ItemClassification.useful,
    "Assembly Line": ItemClassification.progression,
    "Steel": ItemClassification.progression,
    "Medicine": ItemClassification.useful,
    ...
    "Stealth": ItemClassification.useful,
...
# On top of our regular itempool, our world must be able to create arbitrary amounts of filler as requested by core.
